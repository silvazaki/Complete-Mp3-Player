...
class PlayerTest extends JFrame {
	...
	PlayerTest() {
		setTitle("ECHO");
//		setIconImage(Toolkit.getDefaultToolkit().getImage(PlayerTest.class.getResource("C:\\Users\\User\\Downloads\\Java-MP3-player-master\\MP3 Player\\src\\Image\\clio-emt-speaker.png")));
		setResizable(false);
